...
#   def setUp(self):
#     self.user_Jonny = User(username = 'Jonny', password = 'potato', email = 'jonny@msn.com')
#     self.new_review = Review(movie_id=12345,movie_title='Review for movies',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",movie_review='This movie is the best thing since sliced bread',user = self.user_Jonny )
...
#     self.assertEquals(self.new_review.user,self.user_Jonny)
